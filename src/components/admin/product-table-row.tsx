    ...
    <>
      ...
      <div className="lg:hidden border rounded-lg p-4 space-y-4 hover:bg-gray-50 transition-colors">
        ...
        <div className="flex items-center justify-between pt-2 border-t">
          ...
          <ItemActions item={item} itemType={itemType} deleting={deleting} onDelete={onDelete} />
        </div>
      </div>
...
function ItemActions({ item, itemType, deleting, onDelete }: ItemActionsProps) {
  const baseUrl = itemType === 'product' ? '/admin/products' : '/admin/accessories'
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <Link href={`${baseUrl}/edit/${item.id}`}>
