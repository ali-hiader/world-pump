  ...
  return (
    <hgroup className="flex flex-col items-center gap-4 mt-12 w-full">
      ...
      {showBtn && (
        <Link
          href={"/"}
          className="min-w-80 mx-auto py-2 px-4 outline outline-primary rounded-md text-primary/90 text-center hover:outline-transparent hover:bg-primary hover:text-white transition-all"
        >
          Continue Exploring
        </Link>
      )}
