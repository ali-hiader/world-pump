...
export default function PumpsCategories({ mobile = false, onNavigate }: PumpsCategoriesProps) {
    ...
    return (
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="pumps">
          <AccordionTrigger
            className={`w-full px-4 py-2 rounded-md text-left text-base transition cursor-pointer ${
  ...
  return (
    <Menubar className="focus:outline-none">
      <MenubarMenu>
        ...
        <MenubarContent className="px-2 py-2 focus:outline-none mt-3" align="center">
