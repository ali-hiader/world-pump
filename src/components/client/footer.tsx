   ...
   return (
      <footer className="bg-secondary text-white">
         <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-[2fr_1fr_1fr_1fr] gap-8">
            {/* Company Info */}
            <div>
               <Link href={'/'} className="headingFont text-3xl font-extrabold cursor-pointer">
                  World Pumps
               </Link>{' '}
               <p className="text-sm leading-relaxed sm:max-w-3/4 mt-3 text-gray-200">
                  Providing reliable water pumps, filtration systems, swimming pool solutions, and
                  premium brands to keep your water flowing and lifestyle comfortable.
               </p>
            </div>
