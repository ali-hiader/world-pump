      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <Tabs defaultValue="shipping" className="w-full">
            ...
            <TabsContent value="shipping" className="mt-6 text-gray-700 leading-relaxed space-y-6">
              {/* Shipping Policy */}
              <div>
                <h3 className="text-xl font-medium mb-2 text-gray-950">Shipping Policy</h3>
                <p className="text-gray-600">
                  At <span className="font-medium">World Pumps</span>, we strive to deliver a smooth
                  and reliable shopping experience. We offer both{' '}
                ...
                <ul className="list-disc pl-5 mt-3 space-y-1 text-gray-600">
                  <li>
                    <span className="font-medium">Delivery Time:</span> Orders are typically
                    delivered within <span className="font-medium">4–6 business days</span>.
                  </li>
                  <li>
                    <span className="font-medium">Shipping Charges:</span> Costs vary based on
                    product weight and delivery location.
                  </li>
                  <li>
                    <span className="font-medium">Order Processing:</span> Once your order is
                    placed, our team processes it promptly. For delays, contact{' '}
                    <a
              ...
              <div>
                <h3 className="text-xl font-medium  mb-2 text-gray-950">Refund & Returns Policy</h3>
                <p className="text-gray-600">
                  We aim for 100% customer satisfaction. Refunds or exchanges are available under
                  the following conditions:
                </p>
                <ul className="list-disc pl-5 mt-3 space-y-1 text-gray-600">
                  <li>
                    If the item received is <span className="font-medium">damaged</span>, has a{' '}
                    <span className="font-medium">manufacturing defect</span>, or if the wrong
                    product was shipped.
                  </li>
                  <li>
                    Returns or exchanges are <span className="font-medium">not applicable</span> if
                    the product is damaged due to misuse, mishandling, installation errors, or
                ...
                <p className="mt-3">
                  <span className="font-medium">Important:</span> Any refund or exchange request
                  must be reported within
                  <span className="font-medium"> 48 hours of delivery</span>. Please email us at
                  <a href="mailto:support@worldpumps.com" className="text-blue-600 hover:underline">
                    {' '}
                    support@worldpumps.com
                  </a>
                ...
                <p className="mt-3">
                  ...
                  <span className="font-medium">10 business days</span>. Return shipping costs for
                  faulty or defective items will be covered by us.
                </p>
              </div>
            </TabsContent>
            ...
            >
              ...
              <ul className="list-disc pl-5 mt-3 space-y-1 text-gray-600">
                <li>Ensure that all measurements are accurate before placing your order.</li>
