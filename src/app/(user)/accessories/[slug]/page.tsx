         ...
         <div className="mb-8">
            ...
            <div className="flex items-start justify-between gap-4">
               <div className="flex-1">
                  <h1 className="text-3xl md:text-4xl font-bold headingFont mb-2">
                     {accessory.title}
                  </h1>
               ...
               <Tabs defaultValue="shipping" className="w-full">
                  ...
                  >
                     ...
                     <div>
                        ...
                        <p className="text-muted-foreground mb-4">
                           At <span className="font-medium text-foreground">World Pumps</span>, we
                           ensure reliable delivery of all accessories across Pakistan with both{' '}
                           <span className="font-medium text-foreground">
                              cash on delivery (COD)
                           </span>{' '}
                           and <span className="font-medium text-foreground">prepaid shipping</span>{' '}
                           options.
                        </p>
                        <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                           <li>
                              <span className="font-medium text-foreground">Delivery Time:</span>{' '}
                              4–6 business days for most locations
                           </li>
                           <li>
                              <span className="font-medium text-foreground">Shipping Charges:</span>{' '}
                              Based on weight and delivery location
                           </li>
                           <li>
                     ...
                     {/* Returns Policy */}
                     <div>
                        <h3 className="text-xl font-semibold mb-3 headingFont">
                           Returns & Refunds
                        </h3>
                        <p className="text-muted-foreground mb-4">
                           We accept returns for damaged items, manufacturing defects, or wrong
                           products shipped within{' '}
                  ...
                  >
                     <div>
                        ...
                        <p className="text-muted-foreground mb-4">
                           All accessories come with manufacturer warranty coverage for defects and
                           quality issues.
                        </p>
                        <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
