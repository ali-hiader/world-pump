...
function BlogsPage() {
  ...
  return (
    <main className="px-4 sm:px-[2%] max-w-[1500px] mx-auto py-8">
      ...
      {/* Newsletter Signup */}
      <section className="mt-16 p-8 bg-muted rounded-lg text-center">
        <h2 className="text-2xl font-bold headingFont mb-4">
          Stay Updated with Our Latest Articles
        </h2>
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
          Subscribe to our newsletter and get the latest pump and filtration insights delivered to
          your inbox.
        </p>
