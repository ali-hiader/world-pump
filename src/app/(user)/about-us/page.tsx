        ...
        <div className="grid md:grid-cols-2 gap-10 mt-8 items-center">
          <div className="space-y-4">
            <p className="text-gray-700 leading-relaxed">
              <strong>World Pumps</strong> is a leading provider of water
              engineering solutions, specializing in swimming pool design &
              construction, sauna room installation, water filtration systems,
              and pump technologies. With years of experience and a passion for
              innovation, we deliver end-to-end services for homes, businesses,
              and commercial projects across the region.
            </p>
            <p className="text-gray-600">
              Our team of experts handles everything from concept to
              completion—planning, structural work, plumbing, finishing, and
              ongoing maintenance. We pride ourselves on using the latest
              technology and premium materials to ensure long-lasting
      ...
      <section className="max-w-7xl mx-auto mt-16">
        ...
        <div className="mt-8 space-y-6">
          <p className="text-lg text-gray-700">
            <strong>World Pumps</strong> is a leading provider of water
            engineering solutions, specializing in swimming pool design &
            construction, sauna room installation, water filtration systems, and
            pump technologies. With years of experience and a passion for
            innovation, we deliver end-to-end services for homes, businesses,
            and commercial projects across the region.
          </p>
          <p className="text-gray-600">
            ...
            completion—planning, structural work, plumbing, finishing, and
            ongoing maintenance. We pride ourselves on using the latest
            technology and premium materials to ensure long-lasting performance
          ...
          <p className="text-gray-600 leading-relaxed">
            To bring comfort, safety, and enjoyment to every client by providing
            high-quality water solutions that stand the test of time. Whether
            you’re envisioning a private swimming pool, a commercial wellness
            space, or a large-scale water management project,{" "}
            <strong>World Pumps</strong> is your trusted partner from concept to
            completion.
          </p>
        </div>
      </section>
